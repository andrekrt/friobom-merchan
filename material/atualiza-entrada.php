...
if(isset($_SESSION['idusuario']) && empty($_SESSION['idusuario'])==false){
    ...
    $sql = $db->prepare("UPDATE entradas SET data_recebimento = :recebimento, material = :material, industria = :industria, qtd = :qtd, rua = :rua, predio = :predio, usuario = :usuario WHERE identradas = :id");
