                ...
                <form action="atualiza-forn.php" method="post" >
                    ...
                    <div class="form-row">
                        <div class="form-group col-md-2">
                            ...
                            <input type="text" readonly name="cod" class="form-control" id="cod" value="">
                        </div>
                        <div class="form-group col-md-7">
                            <label for="razao" readonly  class="col-form-label">Razão</label>
                            <input type="text" required name="razao" id="razao" class="form-control" value=""> 
                        </div>
                        <div class="form-group col-md-3">
                            <label for="departamento" class="col-form-label">Fantasia</label>
                            <input type="text" name="fantasia" id="fantasia" required class="form-control">
                        </div>
                    </div>   
            </div>
